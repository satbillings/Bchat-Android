...
/* Validate whether user is able to paste upper case letter in block height text box in the My wallet Rescan screen*/
	...
	public void To_validate_whether_user_is_able_to_paste_uppercase_letter_value_in_blockheight_textbox_in_My_wallet_Rescan_screen ()throws InterruptedException {
		...
		Assert.assertEquals(mywalletpage.getRescanTitle(), "Rescan");
		mywalletpage.ClickBlockHeightTextBox();
		mywalletpage.paste_Value_In_BlockheightTextBox("ABCDEF");
		Assert.assertNotEquals(mywalletpage.getValuesFromBlockheightTextBox(), "ABCDEF");	
		 }	
...
/* Validate whether user is able to paste long text in block height text box in the My wallet Rescan screen*/
	...
	public void To_validate_whether_user_is_able_to_paste_long_text_in_blockheight_textbox_in_My_wallet_Rescan_screen ()throws InterruptedException {
		mywalletpage = new MyWalletScreen(driver);
		Assert.assertEquals(mywalletpage.getRescanTitle(), "Rescan");
		mywalletpage.paste_Value_In_BlockheightTextBox("civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
		Assert.assertNotEquals(mywalletpage.getValuesFromBlockheightTextBox(), "civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
	}	
...
/* Validate if entered height is displayed in block height text box in My wallet rescan screen after user navigates to My wallet dash board screen and again come back to rescan screen */
	...
	public void To_Validate_if_entered_height_is_displayed_in_blockheight_textbox_in_My_wallet_rescan_screen_after_user_navigates_to_My_wallet_dashboard_screen_and_again_come_back_to_rescan_screen () throws InterruptedException {
		...
		Assert.assertEquals(mywalletpage.getRescanTitle(), "Rescan");
		mywalletpage.ClickBlockHeightTextBox();
		mywalletpage.paste_Value_In_BlockheightTextBox("4700000");
		Assert.assertEquals(mywalletpage.getValuesFromBlockheightTextBox(), "4700000");	
		driver.navigate().back();
		driver.navigate().back();
		mywalletpage = new MyWalletScreen(driver);
		Assert.assertEquals(mywalletpage.getMyWalletScreenTitle(), "My Wallet");
...
/* Validate whether user is able to paste empty space value in amount text box in My Wallet send screen.*/
	...
	public void To_validate_whether_user_is_able_to_paste_empty_space_value_in_amount_textbox_in_My_Wallet_send_screen () throws InterruptedException {
		...
		sendpage = new WalletSendScreen(driver);
		Assert.assertEquals(sendpage.pagetitle(),"Send");
		sendpage.paste_Value_In_Amount("     ");
...
/* Validate whether user is able to paste HTML value in amount text box in My Wallet send screen.*/
	...
	public void To_validate_whether_user_is_able_to_paste_HTML_value_in_amount_textbox_in_My_Wallet_send_screen () throws InterruptedException {
		sendpage = new WalletSendScreen(driver);
		Assert.assertEquals(sendpage.pagetitle(),"Send");
		sendpage.paste_Value_In_Amount("<a href=\\\"https://www.example.com\\\">Visit Example</a>");
...
/* Validate whether user is able to paste long text in amount text box in My Wallet send screen.*/
	...
	public void To_validate_whether_user_is_able_to_paste_long_text_in_amount_textbox_in_My_Wallet_send_screen () throws InterruptedException {
		sendpage = new WalletSendScreen(driver);
		Assert.assertEquals(sendpage.pagetitle(),"Send");
		sendpage.paste_Value_In_Amount("civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
		Assert.assertNotEquals(sendpage.get_Values_In_AmountField(),"civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
		}
...
/* Validate the Address text box in My Wallet send screen by entering the long text */
	
	@Test(priority = 163)
	public void To_validate_the_Address_textbox_in_My_Wallet_send_screen_by_entering_the_long_text () throws InterruptedException {
		Enablewalletpage = new EnableWalletScreen(driver);
		Assert.assertEquals(Enablewalletpage.getEnableWalletScreenTitle(),"Wallet");
		Enablewalletpage.ClickEnableWalletCheckBox();
		Enablewalletpage.ClickEnableWalletButton();
		...
		sendpage = new WalletSendScreen(driver);
		Assert.assertEquals(sendpage.pagetitle(),"Send");
		sendpage.Enter_Values_In_Address("civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
		Assert.assertEquals(sendpage.getValuesFromAddressTextBox(),"civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
		sendpage.Clear_Address_textbox();
		}	
	
/* Validate whether user is able to paste long text in Address text box in My Wallet send screen.*/
	
	@Test(priority = 164)
	public void To_validate_whether_user_is_able_to_paste_long_text_in_Address_textbox_in_My_Wallet_send_screen () throws InterruptedException {
		sendpage = new WalletSendScreen(driver);
		Assert.assertEquals(sendpage.pagetitle(),"Send");
		sendpage.paste_Value_In_Address("civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
		Assert.assertEquals(sendpage.getValuesFromAddressTextBox(),"civilian ticket oxidant sixteen luxury costume coal loudly poaching suffice cigar wife aplomb gnome bevel theatrics goat novelty adhesive sawmill beyond dwelt below code sixteen");
		sendpage.Clear_Address_textbox();
		}
	
/* Validate if entered input is displayed in Amount text box in My wallet send screen after user navigated from send screen to dash board screen and again back to send screen */	
/* Validate if entered input is displayed in Address text box in My wallet send screen after user navigated from send screen to dash board screen and again back to send screen */	
	
	@Test(priority = 165)
	public void Validate_if_entered_text_is_displayed_in_Amount_and_Address_textboxes_in_My_wallet_send_screen_after_user_navigated_from_send_screen_to_dashboard_screen_and_again_back_to_send_screen () throws InterruptedException {
		sendpage = new WalletSendScreen(driver);
		Assert.assertEquals(sendpage.pagetitle(),"Send");
		sendpage.click_Amount_textbox();
		sendpage.Enter_Values_In_Amount("10");
		Assert.assertEquals(sendpage.get_Values_In_AmountField(),"10");
		sendpage.click_Address_textbox();
		sendpage.Enter_Values_In_Address("Test");
		Assert.assertEquals(sendpage.getValuesFromAddressTextBox(),"Test");
		driver.navigate().back();
		driver.navigate().back();
		mywalletpage = new MyWalletScreen(driver);
		Assert.assertEquals(mywalletpage.getMyWalletScreenTitle(), "My Wallet");
		...
		sendpage = new WalletSendScreen(driver);
		Assert.assertEquals(sendpage.pagetitle(),"Send");
		Assert.assertNotEquals(sendpage.get_Values_In_AmountField(),"10");
		Assert.assertNotEquals(sendpage.getValuesFromAddressTextBox(),"Test");
	}
