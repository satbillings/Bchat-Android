	...
	public void Configure() throws InterruptedException, IOException, URISyntaxException {
		...
		//try {
			...
			options.setCapability("appium:automationName", "UiAutomator2");	
			 options.setCapability("appium:deviceName", "OnePlus Nord CE3 Lite");		 
			...
			// options.setCapability("enforceXPath1",true);
				options.setApp(System.getProperty("user.dir")+"\\Resources\\Bchat-2.7.2-arm64-v8a-contact-sharing.apk");
